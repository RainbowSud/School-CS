...
while inputLoop is True:
    ...
    if response == 's':
        ...
        elif moneyAdded >= .75 and whittington == 0:
            print("you hear a mechanical whirring but nothing comes out")
            moneyAdded = 0
        else:
        ...
        if moneyAdded >= .75 and escher > 0:
            ...
            moneyAdded = 0
            escher = escher - 1
        elif moneyAdded >= .75 and escher == 0:
            print("you hear a mechanical whirring but nothing comes out")
            moneyAdded = 0
        else:
            print("nothing happens")
        ...
        if moneyAdded >= .75 and daVinci > 0:
            ...
            moneyAdded = 0
            daVinci = daVinci - 1
        elif moneyAdded >= .75 and daVinci == 0:
            print("you hear a mechanical whirring but nothing comes out")
            moneyAdded = 0
        else:
            print("nothing happens")
        ...
        if moneyAdded >= .75 and pollock > 0:
            ...
            moneyAdded = 0
            pollock = pollock - 1
        elif moneyAdded >= .75 and pollock == 0:
            print("you hear a mechanical whirring but nothing comes out")
            moneyAdded = 0
        else:
            print("nothing happens")
